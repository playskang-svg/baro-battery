...
const slides = [
  {
    src: '/images/batterycall_1.webp',
    alt: '자동차 배터리 교체 작업 현장',
    title: '다시 출발할 준비',
    text: '배터리 점검부터 교체 안내까지',
  },
  {
    src: '/images/batterycall_2.webp',
    alt: '배터리 교체 작업 장면',
    title: '빠르게 확인하고 시작',
    text: '차량 상태에 맞춘 배터리 상담',
  },
  {
    src: '/images/batterycall_3.webp',
    alt: '엔진룸 배터리 점검',
    title: '차종에 맞게 정확하게',
    text: '차량 정보와 증상을 먼저 확인',
  },
  {
    src: '/images/batterycall_4.webp',
    alt: '출장 배터리 교체 서비스 현장',
    title: '멈춘 일상에 다시 시동을',
    text: '내 차가 있는 곳에서 시작하세요',
  },
];
    ...
    <main id="main" className="home-v2">
      <section className="hero wrap">
        <div className="hero-copy">
          ...
          <p className="hero-description">
            갑작스러운 방전부터 미리 준비하는 교체까지.<br />
            차종과 현재 상황을 먼저 정리해 보세요.
          </p>
          <div className="hero-actions">
            <Link className="btn lime" href="#quick-inquiry">
              상황 선택하고 시작하기 <ArrowUpRight size={20} />
            </Link>
            <Link className="hero-text-link" href="/service">
              교체 과정 먼저 보기
            </Link>
          </div>
          <div className="hero-assurances" aria-label="서비스 이용 전 안내">
            <span>
              <Check aria-hidden="true" />예약·결제 없이 정보부터 확인
            </span>
            <span>
              <Check aria-hidden="true" />차종·연식만으로 시작
            </span>
          </div>
        </div>
      ...
      <section className="wrap service-overview" aria-label="출장 교체 상담 안내">
        <div className="overview-lead">
          ...
          <span>
            <strong>복잡한 규격은 작업자와 확인해요.</strong>
            <small>차량 정보와 증상을 먼저 남기면 됩니다.</small>
          </span>
        </div>
      ...
      <section className="region-section">
        <div className="wrap region-layout">
          <div>
            ...
            <p>
              내 지역을 선택해 출장 안내를 확인하세요.<br />
              방문 가능 여부와 일정은 상담을 통해 확인합니다.
            </p>
            <Link className="text-link" href="/regions">
              지역별 안내 모두 보기 <ArrowUpRight size={17} />
            </Link>
          </div>
          <RegionExplorer />
        </div>
      ...
      <section className="section wrap confidence-section">
        ...
        <div className="service-heading">
          <h3>
            <CircleCheck aria-hidden="true" />상담부터 교체까지, 이렇게 진행해요.
          </h3>
          <Link className="text-link" href="/service">
            과정과 비용 보기 <ArrowUpRight size={16} />
          </Link>
        </div>
        <Steps />
      </section>
      ...
      <section className="journal-section">
        <div className="wrap">
          ...
          <div className="guide-grid">
            {[guides[7], guides[8], guides[9]].map((guide, index) => (
