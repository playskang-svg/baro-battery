...
출장 전 차량 확인과 제품·총비용 안내를 부탁드립니다.${photos.length?'\n※ 문자 앱에서 첨부할 사진: '+photos.join(', '):''}`;
  ...
  return <form id="sms-inquiry" className="sms-form" onSubmit={e=>{e.preventDefault();void send();}} onChange={()=>setStatus('')}>
